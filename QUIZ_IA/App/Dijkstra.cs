...
namespace App
{
    public partial class Dijkstra : Form
    {
        ...
        private void GenerePropositions(int numEtape, out List<Sommet>[] propositionsOuverts, out int indiceOuvertCorrect, out List<Sommet>[] propositionsFermes, out int indiceFermeCorrect)
        {
